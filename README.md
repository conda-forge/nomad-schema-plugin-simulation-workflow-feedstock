About nomad-schema-plugin-simulation-workflow-feedstock
=======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-schema-plugin-simulation-workflow-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-schema-plugin-simulation-workflow-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-schema-plugin-simulation-workflow
# for installing globally
pixi global install nomad-schema-plugin-simulation-workflow
```
...
It is possible to list all of the versions of `nomad-schema-plugin-simulation-workflow` available on your platform:
...
```
pixi search nomad-schema-plugin-simulation-workflow --channel conda-forge
```
